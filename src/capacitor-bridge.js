...
/**
 * Custom loader for the JSON tour file.
 */
export async function capacitorJsonLoader(url) {
    // Use the smart rewriter that handles both Native and Web paths
    const resolvedUrl = await capacitorUrlRewriter(url);
